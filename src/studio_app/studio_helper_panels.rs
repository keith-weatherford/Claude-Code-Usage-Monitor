...
pub(super) const TEXT_TEMPLATE_VALUES: &[TextTemplateValue] = &[
    ...
    TextTemplateValue {
        group: "Active provider",
        label: "Session pace delta",
        expression: "active.session.pace_delta",
        kind: TextTemplateValueKind::Number,
    },
    TextTemplateValue {
        group: "Active provider",
        label: "Session elapsed fraction",
        expression: "active.session.elapsed_fraction",
        kind: TextTemplateValueKind::Number,
    },
    TextTemplateValue {
        group: "Active provider",
        label: "Weekly pace delta",
        expression: "active.weekly.pace_delta",
        kind: TextTemplateValueKind::Number,
    },
    TextTemplateValue {
        group: "Active provider",
        label: "Weekly elapsed fraction",
        expression: "active.weekly.elapsed_fraction",
        kind: TextTemplateValueKind::Number,
    },
    TextTemplateValue {
        group: "Claude Code",
    ...
    TextTemplateValue {
        group: "Claude Code",
        label: "Session pace delta",
        expression: "claude.session.pace_delta",
        kind: TextTemplateValueKind::Number,
    },
    TextTemplateValue {
        group: "Claude Code",
        label: "Session elapsed fraction",
        expression: "claude.session.elapsed_fraction",
        kind: TextTemplateValueKind::Number,
    },
    TextTemplateValue {
        group: "Claude Code",
        label: "Weekly pace delta",
        expression: "claude.weekly.pace_delta",
        kind: TextTemplateValueKind::Number,
    },
    TextTemplateValue {
        group: "Claude Code",
        label: "Weekly elapsed fraction",
        expression: "claude.weekly.elapsed_fraction",
        kind: TextTemplateValueKind::Number,
    },
    TextTemplateValue {
        group: "Codex",
    ...
    TextTemplateValue {
        group: "Codex",
        label: "Session pace delta",
        expression: "codex.session.pace_delta",
        kind: TextTemplateValueKind::Number,
    },
    TextTemplateValue {
        group: "Codex",
        label: "Session elapsed fraction",
        expression: "codex.session.elapsed_fraction",
        kind: TextTemplateValueKind::Number,
    },
    TextTemplateValue {
        group: "Codex",
        label: "Weekly pace delta",
        expression: "codex.weekly.pace_delta",
        kind: TextTemplateValueKind::Number,
    },
    TextTemplateValue {
        group: "Codex",
        label: "Weekly elapsed fraction",
        expression: "codex.weekly.elapsed_fraction",
        kind: TextTemplateValueKind::Number,
    },
    TextTemplateValue {
        group: "Antigravity",
    ...
    TextTemplateValue {
        group: "Antigravity",
        label: "Session pace delta",
        expression: "antigravity.session.pace_delta",
        kind: TextTemplateValueKind::Number,
    },
    TextTemplateValue {
        group: "Antigravity",
        label: "Session elapsed fraction",
        expression: "antigravity.session.elapsed_fraction",
        kind: TextTemplateValueKind::Number,
    },
    TextTemplateValue {
        group: "Antigravity",
        label: "Weekly pace delta",
        expression: "antigravity.weekly.pace_delta",
        kind: TextTemplateValueKind::Number,
    },
    TextTemplateValue {
        group: "Antigravity",
        label: "Weekly elapsed fraction",
        expression: "antigravity.weekly.elapsed_fraction",
        kind: TextTemplateValueKind::Number,
    },
    TextTemplateValue {
        group: "OpenCode",
    ...
    TextTemplateValue {
        group: "OpenCode",
        label: "Session pace delta",
        expression: "opencode.session.pace_delta",
        kind: TextTemplateValueKind::Number,
    },
    TextTemplateValue {
        group: "OpenCode",
        label: "Session elapsed fraction",
        expression: "opencode.session.elapsed_fraction",
        kind: TextTemplateValueKind::Number,
    },
    TextTemplateValue {
        group: "OpenCode",
        label: "Weekly pace delta",
        expression: "opencode.weekly.pace_delta",
        kind: TextTemplateValueKind::Number,
    },
    TextTemplateValue {
        group: "OpenCode",
        label: "Weekly elapsed fraction",
        expression: "opencode.weekly.elapsed_fraction",
        kind: TextTemplateValueKind::Number,
    },
    TextTemplateValue {
        group: "Cursor",
    ...
    TextTemplateValue {
        group: "Cursor",
        label: "Session pace delta",
        expression: "cursor.session.pace_delta",
        kind: TextTemplateValueKind::Number,
    },
    TextTemplateValue {
        group: "Cursor",
        label: "Session elapsed fraction",
        expression: "cursor.session.elapsed_fraction",
        kind: TextTemplateValueKind::Number,
    },
    TextTemplateValue {
        group: "Cursor",
        label: "Weekly pace delta",
        expression: "cursor.weekly.pace_delta",
        kind: TextTemplateValueKind::Number,
    },
    TextTemplateValue {
        group: "Cursor",
        label: "Weekly elapsed fraction",
        expression: "cursor.weekly.elapsed_fraction",
        kind: TextTemplateValueKind::Number,
    },
    TextTemplateValue {
        group: "Labels",
